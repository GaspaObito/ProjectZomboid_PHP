            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a  class="dropdown-item" id="CategoriaItem" href="Sillas.php">Sillas</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" id="CategoriaItem" href="Controles.php">Controles</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" id="CategoriaItem" href="Procesadores.php">Procesadores</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" id="CategoriaItem" href="Escritorios.php">Escritorios</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" id="CategoriaItem" href="FuentePoder.php">Fuente de poder</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" id="CategoriaItem" href="MemoriaRam.php">Memoria Ram</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" id="CategoriaItem" href="Auriculares.php">Auriculares</a></li>
                        ...
                        <form action="../Registro.php"><input type="submit" class="btn btn-outline-light me-2" value="Registrarse"/></form>
                    </div>
                </div>
            </nav>
        </header>
